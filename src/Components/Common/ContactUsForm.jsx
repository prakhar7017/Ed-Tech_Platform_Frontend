            ...
            <div className="flex flex-col gap-y-8">
                <div className="flex gap-x-4 mt-[3rem]">
                    <label>
                        ...
                        <input type="text" name="text" placeholder="Enter First Name" {...register("firstname",{required:true})}  style={{
                    ...
                    <label>
                        ...
                        <input type="text" name="text" placeholder="Enter Last Name" {...register("lastName")}  style={{
                            boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18)",
                        }}
                        className="w-[13.25rem] rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5 mt-2"/>
                    </label>
                ...
                <label>
                    ...
                    <div className="flex gap-x-4 justify- ">
                        <select name="dropDown" style={{ boxShadow: "inset 0px -1px 0px rgba(255, 255,255, 0.18)"}}
                ...
                <label>
                    <p >Message<sup className="text-pink-200">*</sup></p>
